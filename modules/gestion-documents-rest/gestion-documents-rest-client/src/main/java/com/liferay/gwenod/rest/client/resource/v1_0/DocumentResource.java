...
public interface DocumentResource {
    ...
    public void getDocumentFile(Long documentId) throws Exception;

    public HttpInvoker.HttpResponse getDocumentFileHttpResponse(Long documentId)
            throws Exception;
    ...
    public static class DocumentResourceImpl implements DocumentResource {
        ...
        public void getDocumentFile(Long documentId) throws Exception {
            HttpInvoker.HttpResponse httpResponse = getDocumentFileHttpResponse(
                    documentId);
        ...
        public HttpInvoker.HttpResponse getDocumentFileHttpResponse(
                Long documentId)
                throws Exception {
            ...
            httpInvoker.path(
                    _builder._scheme + "://" + _builder._host + ":" +
                            _builder._port + _builder._contextPath +
                            "/o/gestion-documents-rest/v1.0/document/{documentId}/file");
