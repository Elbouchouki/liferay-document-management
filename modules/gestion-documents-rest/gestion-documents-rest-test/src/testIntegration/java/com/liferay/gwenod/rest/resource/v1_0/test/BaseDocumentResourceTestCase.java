package com.liferay.gwenod.rest.resource.v1_0.test;
...
import com.liferay.gwenod.rest.client.pagination.Page;
import com.liferay.gwenod.rest.client.resource.v1_0.DocumentResource;
...
public abstract class BaseDocumentResourceTestCase {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.gwenod.rest.dto.v1_0.Document.class)) {
	...
	protected boolean equals(Document document1, Document document2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("documentId", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						document1.getDocumentId(), document2.getDocumentId())) {
			...
			if (Objects.equals("file", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						document1.getFile(), document2.getFile())) {
	...
	@Inject
	private com.liferay.gwenod.rest.resource.v1_0.DocumentResource
		_documentResource;
