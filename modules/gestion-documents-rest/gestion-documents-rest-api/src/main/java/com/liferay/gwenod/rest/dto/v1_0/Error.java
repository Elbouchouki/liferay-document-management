...
public class Error implements Serializable {
	...
	public void setFieldErrors(
		UnsafeSupplier<FieldError[], Exception> fieldErrorsUnsafeSupplier) {
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected FieldError[] fieldErrors;
	...
	public String toString() {
		...
		if (fieldErrors != null) {
			...
			for (int i = 0; i < fieldErrors.length; i++) {
				sb.append(String.valueOf(fieldErrors[i]));
	...
	@Schema(
		...
		defaultValue = "com.liferay.gwenod.rest.dto.v1_0.Error",
		name = "x-class-name"
	)
